...
2. **Follow shared prose rules:** Read `~/.claude/skills/_shared/prose-clarity.md` for audience modes (onboarding, operational, decision record, review artifact). This skill is the canonical owner; other skills reference that file.
3. Ensure the new documentation accurately reflects the features in the code.
